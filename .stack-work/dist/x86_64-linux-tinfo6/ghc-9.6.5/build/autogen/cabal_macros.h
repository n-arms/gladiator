...
/* package memory-management-strats-0.1.0.0 */
#ifndef VERSION_memory_management_strats
#define VERSION_memory_management_strats "0.1.0.0"
#endif /* VERSION_memory_management_strats */
#ifndef MIN_VERSION_memory_management_strats
#define MIN_VERSION_memory_management_strats(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_memory_management_strats */
...
#define CURRENT_PACKAGE_KEY "memory-management-strats-0.1.0.0-AhtVkTSF3jp74u9X8GxnQL"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "memory-management-strats-0.1.0.0-AhtVkTSF3jp74u9X8GxnQL"
